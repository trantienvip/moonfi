    ...
    return (
        <div className="banner row">
            <div className="video-header">
                <video loop muted autoPlay controls='' style={{ opacity: 0.6 }}><source src={Fantasy} type="video/mp4" /></video>
            </div>
            <div className="col-md-6 banner-text">
                <p style={{ fontSize: 31 }}>WELCOME TO</p>
                <h1 className="banner-title m-3">MOONF</h1>
                <p>The Fastest Growing Crypto Community on Earth</p>
                <div className="div">
                    <Link to="buy" className="buyido btn btn-success">BUY ON PANCAKESWAP</Link>
                </div>
            </div>
            <div className="col-md-6 banner-text">
                <p>Out Now:</p>
                <h3 className="banner-title-sm">MOONFI APP</h3>
                <p>Get it on:</p>
